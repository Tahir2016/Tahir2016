...
🌐 A passionate **Frontend Developer** who loves creating modern, user-friendly, and responsive web applications.  
💻 Skilled in **React.js, Next.js, TypeScript, JavaScript, Tailwind CSS** and state management tools like **Redux & React Query**.  
🚀 Always eager to learn new technologies and improve performance & UI/UX.  
